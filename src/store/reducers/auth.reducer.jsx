...
// const authReducer = createReducer(initialState, (builder) => {
//     builder
//         .addCase(registerUserFulfilled, (state, action) => {
//             state.isConnected = true;
//             state.token = action.payload.result.token;
...
//             state.userAddressCountry = action.payload.result.user.address_country;
//         })
//         .addCase(registerUserRejected, (state, action) => {
//             state.errorMsg = 'Veuillez remplir toutes les données nécessaires';
//             console.log(action);
//         })
//         .addCase(loginUserFulfilled, (state, action) => {
//             state.isConnected = true;
//             state.token = action.payload.result.token;
//             state.userId = action.payload.result.userToConnect.id;
//             state.userRole = action.payload.result.userToConnect.role;
